...
export const LinedText = (props) => {
    ...
    return (_jsxs(Group, { ...restProps, width: finalWidth, height: finalHeight, children: [_jsx(ItemLabel, { indexes: indexes, x: labelX, y: labelY, width: contentWidth, height: labelHeight, alignHorizontal: alignH, alignVertical: positionV === 'flipped'
                    ? 'bottom'
                    : positionV === 'center'
                        ? 'middle'
