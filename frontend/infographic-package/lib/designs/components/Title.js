...
const Title = (props) => {
    ...
    const MainTitle = (props) => {
        ...
        return ((0, jsx_runtime_1.jsx)(jsx_1.Text, { ...defaultProps, ...props, "data-element-type": "title", children: title }));
    };
    const Desc = (props) => {
        const defaultProps = {
            fontSize: 16,
        ...
        return ((0, jsx_runtime_1.jsx)(jsx_1.Text, { ...defaultProps, ...props, "data-element-type": "desc", children: desc }));
    };
    if (!title && !desc)
        return null;
