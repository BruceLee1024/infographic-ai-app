...
exports.FlexLayout = (0, jsx_1.createLayout)((children, { flexDirection = 'row', justifyContent = 'flex-start', alignItems = 'flex-start', alignContent = 'flex-start', flexWrap = 'nowrap', gap = 0, ...props }) => {
