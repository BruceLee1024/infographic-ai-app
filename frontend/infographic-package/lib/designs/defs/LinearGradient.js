...
const LinearGradient = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("linearGradient", { id: id, ...directionMap[direction], children: [(0, jsx_runtime_1.jsx)("stop", { offset: "0%", stopColor: startColor }), (0, jsx_runtime_1.jsx)("stop", { offset: "100%", stopColor: stopColor })] }));
};
