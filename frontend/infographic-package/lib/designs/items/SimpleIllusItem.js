...
const SimpleIllusItem = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { ...restProps, width: width, height: illusSize + gap + labelBounds.height + gap + 48, flexDirection: "column", alignItems: "center", justifyContent: "center", gap: gap, children: [(0, jsx_runtime_1.jsx)(components_1.Illus, { indexes: indexes, width: illusSize, height: illusSize }), labelContent, (0, jsx_runtime_1.jsx)(components_1.ItemDesc, { indexes: indexes, width: width, alignHorizontal: "center", alignVertical: "top", fill: themeColors.colorTextSecondary, lineNumber: 3, children: desc })] }));
};
