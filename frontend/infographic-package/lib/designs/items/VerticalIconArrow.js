...
const VerticalIconArrow = (props) => {
    ...
    const totalWidth = Math.max(labelBounds.width + dotLineGap + dotLineBounds.width, iconGap + iconBounds.width) *
        2 +
        arrowWidth;
    return ((0, jsx_runtime_1.jsx)(jsx_1.Group, { width: totalWidth, height: height, ...restProps, children: (0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { flexDirection: "row", alignItems: "center", children: [isNormal ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { flexDirection: "column", alignItems: "flex-end", children: [label, desc] }), (0, jsx_runtime_1.jsx)(components_1.Gap, { width: dotLineGap }), dotLine] })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(components_1.Gap, { width: fixedGap }), icon, (0, jsx_runtime_1.jsx)(components_1.Gap, { width: iconGap })] })), (0, jsx_runtime_1.jsxs)(Align_1.AlignLayout, { horizontal: "center", vertical: "middle", children: [(0, jsx_runtime_1.jsx)(VerticalArrow, { width: arrowWidth, height: height, fill: themeColors.colorPrimary }), (0, jsx_runtime_1.jsx)(jsx_1.Text, { width: arrowWidth, height: height, alignHorizontal: "center", alignVertical: "middle", fill: themeColors.colorWhite, fontWeight: "bold", fontSize: 16, children: String(indexes[0] + 1)
                                .padStart(2, '0')
