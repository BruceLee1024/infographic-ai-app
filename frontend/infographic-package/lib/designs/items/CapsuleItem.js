...
const CapsuleItem = (props) => {
    ...
    const labelBounds = (0, jsx_1.getElementBounds)((0, jsx_runtime_1.jsx)(components_1.ItemLabel, { ...labelProps, children: datum.label }));
    const descProps = {
        indexes,
        width: textWidth,
        alignHorizontal: textAlign,
    ...
    const descBounds = (0, jsx_1.getElementBounds)(datum.desc ? (0, jsx_runtime_1.jsx)(components_1.ItemDesc, { ...descProps, children: datum.desc }) : null);
