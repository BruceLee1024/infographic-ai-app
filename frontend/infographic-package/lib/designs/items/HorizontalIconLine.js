...
const HorizontalIconLine = (props) => {
    ...
    if (positionV === 'flipped') {
        return ((0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { ...restProps, flexDirection: "column", alignItems: "center", children: [(0, jsx_runtime_1.jsx)(components_1.Gap, { height: bottomBalance }), time, icon, (0, jsx_runtime_1.jsx)(components_1.Gap, { height: 5 }), line, label, desc, (0, jsx_runtime_1.jsx)(components_1.Gap, { height: topBalance })] }));
    }
    return ((0, jsx_runtime_1.jsxs)(layouts_1.FlexLayout, { ...restProps, flexDirection: "column", alignItems: "center", children: [(0, jsx_runtime_1.jsx)(components_1.Gap, { height: topBalance }), label, desc, line, (0, jsx_runtime_1.jsx)(components_1.Gap, { height: 5 }), icon, time, (0, jsx_runtime_1.jsx)(components_1.Gap, { height: bottomBalance })] }));
};
