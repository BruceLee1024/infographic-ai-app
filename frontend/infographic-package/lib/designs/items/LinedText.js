...
const LinedText = (props) => {
    ...
    const finalWidth = showUnderline
        ...
        : contentWidth;
    const finalHeight = restProps.height ?? totalHeight;
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_1.Group, { ...restProps, width: finalWidth, height: finalHeight, children: [(0, jsx_runtime_1.jsx)(components_1.ItemLabel, { indexes: indexes, x: labelX, y: labelY, width: contentWidth, height: labelHeight, alignHorizontal: alignH, alignVertical: positionV === 'flipped'
                    ? 'bottom'
                    : positionV === 'center'
                        ? 'middle'
