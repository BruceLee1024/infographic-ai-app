...
const IconBadge = (props) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_1.Group, { ...restProps, width: width, height: height, children: [(0, jsx_runtime_1.jsxs)(jsx_1.Defs, { children: [(0, jsx_runtime_1.jsxs)("radialGradient", { id: gradientId, cx: "50%", cy: "30%", r: "70%", children: [(0, jsx_runtime_1.jsx)("stop", { offset: "0%", stopColor: (0, tinycolor2_1.default)(themeColors.colorPrimary)
                                    .lighten(30)
