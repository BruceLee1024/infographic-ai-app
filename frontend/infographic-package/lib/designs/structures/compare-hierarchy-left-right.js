...
const CompareHierarchyLeftRight = (props) => {
    ...
    const itemContent = ((0, jsx_runtime_1.jsx)(Item, { indexes: [0, 0], data: data, datum: items[0]?.children?.[0] || items[2] }));
    ...
    const addDecoElement = (side, pos, indexes) => {
        ...
        if (decoration === 'split-line') {
            decoElements.push((0, jsx_runtime_1.jsx)(SplitLine, { ...props }));
        }
        else if (decoration === 'dot-line') {
            decoElements.push((0, jsx_runtime_1.jsx)(DotLine, { ...props }));
        }
    };
    if (surround) {
