...
exports.THEME_NAMES = exports.ITEM_NAMES = exports.STRUCTURE_NAMES = exports.TEMPLATE_NAMES = void 0;
exports.getTemplateDisplayName = getTemplateDisplayName;
exports.getStructureDisplayName = getStructureDisplayName;
exports.getItemDisplayName = getItemDisplayName;
exports.getThemeDisplayName = getThemeDisplayName;
// 模板名称翻译
...
function getTemplateDisplayName(templateId) {
    return exports.TEMPLATE_NAMES[templateId] || templateId;
}
/**
 * 获取结构的中文名称
 */
function getStructureDisplayName(structureId) {
    return exports.STRUCTURE_NAMES[structureId] || structureId;
}
/**
 * 获取数据项的中文名称
 */
function getItemDisplayName(itemId) {
    return exports.ITEM_NAMES[itemId] || itemId;
}
/**
 * 获取主题的中文名称
 */
function getThemeDisplayName(themeId) {
    return exports.THEME_NAMES[themeId] || themeId;
}
